...
<body>
    <nav>
        <div class="btn-nav">
             ...
             <img class="registros" src="../icons/verificacion.png" onclick="print()" >
        </div>
    </nav>
        ...
        <div class="tarjetero1">
            ...
            <div class="tarjetero2">
                <div class="tarjeta t2">
                    ...
                    <button onclick="location='listado.html'"><h5>Agregar</h5> <img src="../icons/fecha-derecha.svg" alt="flecha"></button>
